...
restaurants_attributes = [
  ...
  { name:"Megan's", location: "27 Circus West Village, London SW11 8NN", description: "Megan’s is open for brunch, lunch, dinner and cocktails every single day!", area: Area.find_by_name("South London"), price: "££", cuisine: "Mediterranean", opening_time: 0800, closing_time: 2000 },
